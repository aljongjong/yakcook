...
@WebServlet("/answeredqna")
public class answeredQNAController extends HttpServlet{
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		int qnaNo = Integer.parseInt(req.getParameter("qnaNo"));
		QNAVo qv = new serviceManageService().selectAnswerQNA(qnaNo);
		req.setAttribute("qv", qv);
		req.getRequestDispatcher("/WEB-INF/views/serviceManage/answeredQNA.jsp").forward(req, resp);
	}
	@Override
